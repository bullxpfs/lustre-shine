...
class TargetTest(unittest.TestCase):
    ...
    def test_active(self):
        ...
        self.assertEqual(len(fs.components.managed(include_inactive=True)), 3)
        self.assertEqual(str(fs.components.managed(include_inactive=True)), 'active-OST[0000-0002]')
